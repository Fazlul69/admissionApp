        ...
        <div class="col-md-8">
            ...
            <form method="POST" action="{{route('submitform')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="name_bangla" class="form-label">নাম(বাংলা)</label>
                            ...
                            <input id="name_bangla" type="text" class="form-control" name="name_bangla" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="mySelectBox" aria-label="Defaul" name="category">
                                ...
                                <option value="{{$categorie->id}}" name="parent_working_here">{{$categorie->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div>আবেদনকারীর সহোদর/সহোদরা বা জমজ ভাই/বোন অত্র বিদ্যালয়ে অধ্যয়ণ করে কি না? &nbsp; &nbsp;
                        <label>
                            <input type="radio" name="isstudent" value="yesagain"> হ্যাঁ</label>
                        <label>
                            <label>
                                <input type="radio" name="isstudent" value="noagain"> না</label>
                            <label>
                    </div>
